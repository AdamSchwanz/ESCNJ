...
const SetPassword = ({ userData, onModalClose }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setErrors((prevState) => ({ ...prevState, setPassword: error?.response?.data?.error || "Something Went Wrong!" }));
        } finally {
        ...
        <div className="set-password">
            ...
            <div className='form'>
                    ...
                    <div className='password-wrapper'>
                        ...
                        <div className="password-eye">
                            {!showPassword.newPassword ?
                                <FaRegEye size={20} onClick={() => toggleShowPassword("newPassword")} />
                                :
                                <FaRegEyeSlash size={20} onClick={() => toggleShowPassword("newPassword")} />
                            }
                        </div>
                    </div>
                    ...
                    <div className='password-wrapper'>
                        ...
                        <div className="password-eye">
                            {!showPassword.confirmPassword ?
                                <FaRegEye size={20} onClick={() => toggleShowPassword("confirmPassword")} />
                                :
                                <FaRegEyeSlash size={20} onClick={() => toggleShowPassword("confirmPassword")} />
                            }
                        </div>
                    </div>
                ...
                <div className='input-container'>
                    ...
                    {errors.setPassword && <div className='error'>{errors.setPassword}</div>}
                </div>
            </div>
        </div>
    )
